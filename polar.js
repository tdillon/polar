...
class PolarClock {
    constructor(theme) {
        ...
        let callbacks = [
            { type: RingType.Minute, func: (ts) => ts.m },
            { type: RingType.Hour, func: (ts) => ts.h },
            { type: RingType.Day, func: (ts) => ts.d },
            { type: RingType.Week, func: (ts) => ts.w },
            { type: RingType.Month, func: (ts) => ts.mo },
            { type: RingType.Year, func: (ts) => ts.y }
        ];
...
var RingType;
(function (RingType) {
    RingType[RingType["Minute"] = 0] = "Minute";
    RingType[RingType["Hour"] = 1] = "Hour";
    RingType[RingType["Day"] = 2] = "Day";
    RingType[RingType["Week"] = 3] = "Week";
    RingType[RingType["Month"] = 4] = "Month";
    RingType[RingType["Year"] = 5] = "Year";
})(RingType || (RingType = {}));
let theme = {
    bg: 'rgb(0,0,0)',
    rings: [
